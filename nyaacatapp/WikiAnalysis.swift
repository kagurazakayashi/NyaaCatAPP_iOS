 ...
 */
    ...
    func 维基内容(域名:String) -> String {
        ...
        if (内容区间.characters.count == 0) {
            ...
            内容区间 = 内容区间.stringByReplacingOccurrencesOfString("<a href=\"/", withString: "<a href=\"\(域名)/", options: NSStringCompareOptions.LiteralSearch, range: nil)
        }
